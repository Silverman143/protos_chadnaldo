...
type LevelUpCharacterResponse struct {
	...
	CoinsBalance int32 `protobuf:"varint,3,opt,name=coins_balance,json=coinsBalance,proto3" json:"coins_balance,omitempty"` // Gold balance of user
}
...
func (x *LevelUpCharacterResponse) GetCoinsBalance() int32 {
	if x != nil {
...
var file_character_character_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x6f,
