...
const (
	Currency_CURRENCY_UNSPECIFIED Currency = 0 // Значение по умолчанию, если не указано
	Currency_COINS                Currency = 1 // Валюта "coins"
	Currency_GEMS                 Currency = 2 // Валюта "gems"
)
...
func (x *DefaultRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetUserGemsBalanceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Gems int64 `protobuf:"varint,1,opt,name=gems,proto3" json:"gems,omitempty"` // User gems balance
}

func (x *GetUserGemsBalanceResponse) Reset() {
	*x = GetUserGemsBalanceResponse{}
	mi := &file_user_user_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetUserGemsBalanceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserGemsBalanceResponse) ProtoMessage() {}

func (x *GetUserGemsBalanceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserGemsBalanceResponse.ProtoReflect.Descriptor instead.
func (*GetUserGemsBalanceResponse) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{5}
}

func (x *GetUserGemsBalanceResponse) GetGems() int64 {
	if x != nil {
		return x.Gems
	}
	return 0
...
type InitiatePaymentRequest struct {
	...
	Currency      Currency `protobuf:"varint,3,opt,name=currency,proto3,enum=user.Currency" json:"currency,omitempty"`
...
func (x *InitiatePaymentRequest) GetCurrency() Currency {
	if x != nil {
		return x.Currency
	}
...
func (x *InitiatePaymentRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
type FinalizePaymentRequest struct {
	...
	Currency  Currency `protobuf:"varint,2,opt,name=currency,proto3,enum=user.Currency" json:"currency,omitempty"`
	Complete  bool     `protobuf:"varint,3,opt,name=complete,proto3" json:"complete,omitempty"` // true to complete the transaction, false to cancel
}
...
func (x *FinalizePaymentRequest) GetCurrency() Currency {
	if x != nil {
		return x.Currency
	}
	return Currency_CURRENCY_UNSPECIFIED
...
type FinalizePaymentResponse struct {
	...
	Success      bool   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	LeftAmount   int64  `protobuf:"varint,2,opt,name=left_amount,json=leftAmount,proto3" json:"left_amount,omitempty"`
...
func (x *FinalizePaymentResponse) GetLeftAmount() int64 {
	if x != nil {
		return x.LeftAmount
	}
	return 0
...
func (x *AddCoinsToUserRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
type AddGemsToUserRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId     int64  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	GemsAmount int64  `protobuf:"varint,2,opt,name=gems_amount,json=gemsAmount,proto3" json:"gems_amount,omitempty"`
	Payload    string `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
}

func (x *AddGemsToUserRequest) Reset() {
	*x = AddGemsToUserRequest{}
	mi := &file_user_user_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AddGemsToUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddGemsToUserRequest) ProtoMessage() {}

func (x *AddGemsToUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddGemsToUserRequest.ProtoReflect.Descriptor instead.
func (*AddGemsToUserRequest) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{18}
}

func (x *AddGemsToUserRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AddGemsToUserRequest) GetGemsAmount() int64 {
	if x != nil {
		return x.GemsAmount
	}
	return 0
...
func (x *AddGemsToUserRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
type AddGemsToUserResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GemsTotal int64 `protobuf:"varint,1,opt,name=gems_total,json=gemsTotal,proto3" json:"gems_total,omitempty"`
}

func (x *AddGemsToUserResponse) Reset() {
	*x = AddGemsToUserResponse{}
	mi := &file_user_user_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AddGemsToUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddGemsToUserResponse) ProtoMessage() {}

func (x *AddGemsToUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddGemsToUserResponse.ProtoReflect.Descriptor instead.
func (*AddGemsToUserResponse) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{19}
}

func (x *AddGemsToUserResponse) GetGemsTotal() int64 {
	if x != nil {
		return x.GemsTotal
	}
	return 0
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x29, 0x0a, 0x0e, 0x44, 0x65,
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07,
	...
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x33, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x22, 0x30, 0x0a, 0x1a,
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x47, 0x65, 0x6d, 0x73, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x67, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x67, 0x65, 0x6d, 0x73, 0x22, 0x9d,
	...
	0x52, 0x09, 0x69, 0x73, 0x50, 0x72, 0x65, 0x6d, 0x69, 0x75, 0x6d, 0x22, 0xb6, 0x01, 0x0a, 0x16,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x63, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x75, 0x73, 0x65, 0x72,
	...
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79,
	0x6c, 0x6f, 0x61, 0x64, 0x22, 0x58, 0x0a, 0x17, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x65,
	...
	0x52, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x7f,
	0x0a, 0x16, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	...
	,
	...
	,
	...
	0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x76, 0x61, 0x74,
	0x61, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x76,
	0x61, 0x74, 0x61, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x3b, 0x0a, 0x0b, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	...
	,
	...
	,
...
var file_user_user_proto_goTypes = []any{
	(Currency)(0),                       // 0: user.Currency
	(*DefaultRequest)(nil),              // 1: user.DefaultRequest
	...
	(*GetUserGemsBalanceResponse)(nil),  // 6: user.GetUserGemsBalanceResponse
	(*PartialUpdateUserRequest)(nil),    // 7: user.PartialUpdateUserRequest
	(*PartialUpdateUserResponse)(nil),   // 8: user.PartialUpdateUserResponse
	(*UserData)(nil),                    // 9: user.UserData
	(*InitiatePaymentRequest)(nil),      // 10: user.InitiatePaymentRequest
	(*InitiatePaymentResponse)(nil),     // 11: user.InitiatePaymentResponse
	(*FinalizePaymentRequest)(nil),      // 12: user.FinalizePaymentRequest
	(*FinalizePaymentResponse)(nil),     // 13: user.FinalizePaymentResponse
	(*GetReferralsInfoRequest)(nil),     // 14: user.GetReferralsInfoRequest
	(*GetReferralsInfoResponse)(nil),    // 15: user.GetReferralsInfoResponse
	(*ReferralInfo)(nil),                // 16: user.ReferralInfo
	(*AddCoinsToUserRequest)(nil),       // 17: user.AddCoinsToUserRequest
	(*AddCoinsToUserResponse)(nil),      // 18: user.AddCoinsToUserResponse
	(*AddGemsToUserRequest)(nil),        // 19: user.AddGemsToUserRequest
	(*AddGemsToUserResponse)(nil),       // 20: user.AddGemsToUserResponse
	(*fieldmaskpb.FieldMask)(nil),       // 21: google.protobuf.FieldMask
	(*timestamppb.Timestamp)(nil),       // 22: google.protobuf.Timestamp
}
var file_user_user_proto_depIdxs = []int32{
	9,  // 0: user.GetUserResponse.user_data:type_name -> user.UserData
	9,  // 1: user.CreateUserRequest.user_data:type_name -> user.UserData
	9,  // 2: user.PartialUpdateUserRequest.user_data:type_name -> user.UserData
	21, // 3: user.PartialUpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	9,  // 4: user.PartialUpdateUserResponse.updated_user:type_name -> user.UserData
	0,  // 5: user.InitiatePaymentRequest.currency:type_name -> user.Currency
	0,  // 6: user.FinalizePaymentRequest.currency:type_name -> user.Currency
	16, // 7: user.GetReferralsInfoResponse.referrals_info:type_name -> user.ReferralInfo
	22, // 8: user.ReferralInfo.last_active:type_name -> google.protobuf.Timestamp
	1,  // 9: user.User.GetUserData:input_type -> user.DefaultRequest
	3,  // 10: user.User.CreateUser:input_type -> user.CreateUserRequest
	1,  // 11: user.User.GetUserCoinsBalance:input_type -> user.DefaultRequest
	1,  // 12: user.User.GetUserGemsBalance:input_type -> user.DefaultRequest
	7,  // 13: user.User.PartialUpdateUser:input_type -> user.PartialUpdateUserRequest
	10, // 14: user.User.InitiatePayment:input_type -> user.InitiatePaymentRequest
	12, // 15: user.User.FinalizePayment:input_type -> user.FinalizePaymentRequest
	14, // 16: user.User.GetReferralsInfo:input_type -> user.GetReferralsInfoRequest
	17, // 17: user.User.AddCoinsToUser:input_type -> user.AddCoinsToUserRequest
	19, // 18: user.User.AddGemsToUser:input_type -> user.AddGemsToUserRequest
	2,  // 19: user.User.GetUserData:output_type -> user.GetUserResponse
	4,  // 20: user.User.CreateUser:output_type -> user.CreateUserResponse
	5,  // 21: user.User.GetUserCoinsBalance:output_type -> user.GetUserCoinsBalanceResponse
	6,  // 22: user.User.GetUserGemsBalance:output_type -> user.GetUserGemsBalanceResponse
	8,  // 23: user.User.PartialUpdateUser:output_type -> user.PartialUpdateUserResponse
	11, // 24: user.User.InitiatePayment:output_type -> user.InitiatePaymentResponse
	13, // 25: user.User.FinalizePayment:output_type -> user.FinalizePaymentResponse
	15, // 26: user.User.GetReferralsInfo:output_type -> user.GetReferralsInfoResponse
	18, // 27: user.User.AddCoinsToUser:output_type -> user.AddCoinsToUserResponse
	20, // 28: user.User.AddGemsToUser:output_type -> user.AddGemsToUserResponse
