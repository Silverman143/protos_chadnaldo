...
const (
	...
	UserService_PartialUpdateUser_FullMethodName = "/user.UserService/PartialUpdateUser"
)
...
func (c *userServiceClient) PartialUpdateUser(ctx context.Context, in *PartialUpdateUserRequest, opts ...grpc.CallOption) (*PartialUpdateUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) PartialUpdateUser(context.Context, *PartialUpdateUserRequest) (*PartialUpdateUserResponse, error) {
...
func _UserService_PartialUpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).PartialUpdateUser(ctx, req.(*PartialUpdateUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
