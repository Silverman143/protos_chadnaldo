...
const (
	...
	PaymentService_HandleTelegramSuccessfulPayment_FullMethodName = "/payment.PaymentService/HandleTelegramSuccessfulPayment"
)
...
type PaymentServiceClient interface {
	...
	HandleTelegramSuccessfulPayment(ctx context.Context, in *HandleTelegramSuccessfulPaymentRequest, opts ...grpc.CallOption) (*HandleTelegramSuccessfulPaymentResponse, error)
}
...
func (c *paymentServiceClient) HandleTelegramSuccessfulPayment(ctx context.Context, in *HandleTelegramSuccessfulPaymentRequest, opts ...grpc.CallOption) (*HandleTelegramSuccessfulPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HandleTelegramSuccessfulPaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_HandleTelegramSuccessfulPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	HandleTelegramSuccessfulPayment(context.Context, *HandleTelegramSuccessfulPaymentRequest) (*HandleTelegramSuccessfulPaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) HandleTelegramSuccessfulPayment(context.Context, *HandleTelegramSuccessfulPaymentRequest) (*HandleTelegramSuccessfulPaymentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleTelegramSuccessfulPayment not implemented")
}
...
func _PaymentService_HandleTelegramSuccessfulPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HandleTelegramSuccessfulPaymentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).HandleTelegramSuccessfulPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_HandleTelegramSuccessfulPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).HandleTelegramSuccessfulPayment(ctx, req.(*HandleTelegramSuccessfulPaymentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HandleTelegramSuccessfulPayment",
			Handler:    _PaymentService_HandleTelegramSuccessfulPayment_Handler,
		},
	},
